	...
	function setVal(){
		...
		for(var i = 0; i < list.length; i++){
			...
			if(radio.checked){
				...
				window.opener.document.getElementById("appOrgCode_Txt").value = appOrgcod;
...
<body>
	<form action="${pageContext.request.contextPath}/slvb116Controller/search">
					...
					<table>
						...
						<tr>
							...
							<td class="label_left_popup">
								<input type="text" id="orgCode_Txt" maxlength="12" size="20" name="orgcod" value="${appOrgCode_text}"/>
							</td>
							<td class="space_area">&nbsp;</td>
							<td class="label_color_popup"><nobr>組織名１</nobr></td>
							<td class="label_left_popup">
								<input type="text" id="orgName1_Txt" maxlength="35" size="35" name="orgnam1"/>
							</td>
						</tr>
					</table>
				</td>
