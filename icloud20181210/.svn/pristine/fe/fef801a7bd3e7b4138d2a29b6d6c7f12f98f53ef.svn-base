 ...
 ******************************************************************************/
public  interface Lmm107Service {
	...
	public List<HashMap<String, String>> findLmm107(Integer searchScope_Rdo, String appOrgCode_Txt,
			Object evtmrgcod_Txt, Object evtmrgnam_Txt);
}
