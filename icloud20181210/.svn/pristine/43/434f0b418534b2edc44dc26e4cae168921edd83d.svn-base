...
public interface Lmm114Mapper {
	 ...
	 * 
	 * @author 作者:
	 * @createDate 创建时间：2019年6月1日上午9:15:19
	 * @version 版本:
	 * @Explain 说明:查询申请组织名
	 * @Email 邮箱:
	 */
	public String findCodeName(@Param("code") String code);
	/**
	 * 
	 * @author 作者:
	 ...
	 * @Email 邮箱:
	 */
	public int yanZhengXingui(GcLmmmy gcLmmmy);
	/**
	 * @author 作者:
