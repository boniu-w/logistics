...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/lmm117.js"></script>
<script type="text/javascript"></script>
</head>
<body>
<form action="http://localhost:8080/icloud20181210/lmm117Controller/findSomeField2" method="post">
<table  class="body">
    <tr>
    <td colspan="2">
