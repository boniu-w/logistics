...
/**
 * Lvbtodrorg generated by MyEclipse Persistence Tools
 */

public class Lvbtodrorg implements java.io.Serializable {

	// Fields

	private LvbtodrorgId id;
	...
	/** minimal constructor */
	public Lvbtodrorg(LvbtodrorgId id) {
		this.id = id;
	}

	/** full constructor */
	public Lvbtodrorg(LvbtodrorgId id, String orgkbn, String orgcod,
	...
	public LvbtodrorgId getId() {
		return this.id;
	}

	public void setId(LvbtodrorgId id) {
		this.id = id;
	}
