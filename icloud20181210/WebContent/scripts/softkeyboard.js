...
function   prohibitRightClick(){ 
                if(window.event.button   ==   2   ||   window.event.button   ==   3   ||   window.event.button   ==   6   ||   window.event.button   ==   7){ 
                return   false; 
        } 
}
if   (window.Event)   
